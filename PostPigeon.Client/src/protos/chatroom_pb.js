...
goog.exportSymbol('proto.chatroom.Status', null, global);
...
proto.chatroom.UserResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = /** @type {!proto.chatroom.Status} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    case 4:
      var value = /** @type {string} */ (reader.readString());
 ...
 * @return {!proto.chatroom.Status}
 */
proto.chatroom.UserResponse.prototype.getStatus = function() {
  return /** @type {!proto.chatroom.Status} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/**
 * @param {!proto.chatroom.Status} value
 * @return {!proto.chatroom.UserResponse} returns this
 */
